...
const GithubBtn = () => {
  const handleClick = () => {
    window.open("https://github.com/Z3belek/Vistypo", "_blank");
  };
  
  return (
    <button onClick={handleClick} className="group relative dark:bg-neutral-800 bg-neutral-200 rounded-l-full p-px overflow-hidden cursor-pointer">
      <span className="absolute inset-0 rounded-l-full overflow-hidden">
        <span className="inset-0 absolute pointer-events-none select-none">
          <span
            className="block -translate-x-1/2 -translate-y-1/3 size-24 blur-xl"
            style={{
              background:
                "linear-gradient(135deg, rgb(255, 105, 136), rgb(207, 1, 63), rgb(173, 4, 60))",
            }}
          ></span>
        </span>
      </span>
      ...
      >
        <span
          className="block z-0 h-full w-12 blur-xl -translate-x-1/2 rounded-l-full"
          style={{
            animation:
      ...
      <span className="flex items-center justify-center gap-1 relative z-[1] dark:bg-neutral-950/90 bg-neutral-50/90 rounded-l-full py-2 px-4 pl-2 w-full">
        <span className="relative group-hover:scale-105 transition-transform group-hover:rotate-[360deg] duration-500">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop stopColor="#94073b"></stop>
                <stop offset="0.575" stopColor="#cf013f"></stop>
                <stop offset="1" stopColor="#ad043c"></stop>
              </linearGradient>
              <linearGradient
          ...
          <span
            className="rounded-l-full size-11 absolute opacity-0 dark:opacity-30 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 blur-lg"
            style={{
              animation:
                "14s ease-in-out 0s infinite alternate none running star-shine",
              background:
                "linear-gradient(135deg, rgb(242, 59, 59), rgb(255, 105, 136), rgb(207, 1, 63), rgb(173, 4, 60))",
            }}
          ></span>
        </span>
